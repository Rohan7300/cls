...
class VanHireChangeDAActivity : AppCompatActivity() {
    ...
    var currMilegae = String()
    var edtBlue = String()
    var edtcomment: String? = null
...
//        }
        ...
        observers()
        if (intent != null) {
            binding.atvDOB.setText(intent?.getStringExtra("DOB"))
            binding.atvLicenseNumber.setText(intent?.getStringExtra("LICENSENO"))
            binding.aTvLicenseStartDate.setText(intent?.getStringExtra("LICENSESTART"))
            binding.aTvLicenseEndDate.setText(intent?.getStringExtra("LICENSEEND"))
            binding.vanType.setText(intent.getStringExtra("VehicleType"))
            currMilegae = intent.getStringExtra("CURRENTMILEAGE").toString()
            edtBlue = intent.getStringExtra("BLUEMILEAGE").toString()
            CLIENTUNIQUEID = intent.getStringExtra("CLIENTUNIQUEID").toString()
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK) {
                ...
                if (outputUri != null) {
                    ...
                    createBackgroundUploadRequest(inputData, this@VanHireChangeDAActivity, 2)
    ...
    private fun showSignatureDialog() {
        ...
        dialog.setSignatureListener(object : SignatureDialogListener {
            override fun onSignatureSaved(bitmap: Bitmap) {
                if (checkAll()) {
                    var vehType = ""
                    if (DependencyClass.crDASelectedVehicleType!!.contains("SMALL VAN")) {
                        vehType = "SV"
                    } else if (DependencyClass.crDASelectedVehicleType!!.contains("LARGE VAN")) {
                        vehType = "LV"
                    }

                    val bse64 = "data:image/png;base64," + bitmapToBase64(bitmap)
                    mainViewModel.ChangeALlocatedDAvehicle(
                        VehicleAllocateTODARequestBody(
                            binding.checkBoxTickToConfirmAccidents.isChecked,
                            false,
                            false,
                            edtBlue,
                            0,
                            ...
                            "",
                            "",
                            binding.checkboxConvictions.isChecked,
                            false,
                            false,
                            binding.atvDOB.text.toString(),
                            "",
                            "",
                            DependencyClass.VehicleAllocatedTODAID,
                            0,
                            0,
                            0,
                            0,
                            0,
                            "2024-10-03T11:06:22.643Z",
                            true,
                            true,
                            false,
                            false,
                            false,
                            binding.aTvLicenseEndDate.text.toString(),
                            "",
                            "",
                            binding.atvLicenseNumber.text.toString(),
                            "",
                            "",
                            binding.aTvLicenseStartDate.text.toString(),
                            "",
                            "",
                            DependencyClass.selectedVehicleIdDA,
                            prefs.vehLmId.toInt(),
                            prefs.companyId.toInt(),
                            0,
                            0,
                            bse64,
                            "",
                            ...
                            null,
                            0,
                            DependencyClass.selectedVehicleFuelIdDA,
                            currMilegae,
                            selectedVehicleOilLevelListIdDA,
                            DependencyClass.selectedVehicleLocIdDA,
                            vehType
                        )
//                            binding.checkBoxTickToConfirmAccidents.isChecked,
//                            false,
...
//                            vehType
                    ...
                    mainViewModel.CHangeAllocatedDAVehicle.observe(
                        this@VanHireChangeDAActivity,
                        Observer {
                            if (it?.Status == "200") {
                                Toast.makeText(
                                    this@VanHireChangeDAActivity,
                                    "Vehicle is Allocated to DA",
                                    Toast.LENGTH_SHORT
                                ).show()
                            }
...
//                            AccidentsChk2 = false,
//                            AccidentsChk3 = false,
//                            AddBlueMileage = DependencyClass.addBlueMileage!!,
//                            ChangeVehCount = 0,
...
//                            LicenseStartDate3 = "",
//                            NewVmId = 0,
//                            OldVmId = DependencyClass.selectedVehicleId,
//                            ParentCompanyId = DependencyClass.selectedCompanyId,
//                            RequestTypeIds = listOf(DependencyClass.selectedRequestTypeId),
...
//                            VehCurrentFuelLevelId = DependencyClass.selectedVehicleFuelId,
//                            VehCurrentMileage = DependencyClass.crrMileage.toString(),
//                            VehCurrentOILLevelId = DependencyClass.selectedVehicleOilLevelListId,
//                            VehSelectedLocationId = DependencyClass.selectedVehicleLocId,
//                            VehType = vehType,
...
//                    )
    ...
    fun showAlertCharge() {
        ...
        val view: View = factory.inflate(R.layout.dialog_today_tomorrow, null)
        val deleteDialog: androidx.appcompat.app.AlertDialog =
            androidx.appcompat.app.AlertDialog.Builder(this).create()/*        val imageView: ImageView = view.findViewById(R.id.ic_cross_orange)
                imageView.setOnClickListener {
                    deleteDialog.dismiss()
                }*/
        val btone: TextView = view.findViewById(R.id.save)

        val r1: CheckBox = view.findViewById(R.id.r1)
        val r2: CheckBox = view.findViewById(R.id.r2)
        val edt: EditText = view.findViewById(R.id.edtcomment)
        if (edt.text.toString().isNotEmpty()) {
            edtcomment = edt.text.toString()
...
//        }
        ...
        btone.setOnClickListener {
            if (r1.isChecked || r2.isChecked) {
                ...
                Toast.makeText(this, "Please select charge day.", Toast.LENGTH_SHORT).show()
            }
